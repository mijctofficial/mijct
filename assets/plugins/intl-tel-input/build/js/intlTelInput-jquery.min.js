! function(i) {
    "object" == typeof module && module.exports ? module.exports = i(require("jquery"), window, document) : "function" == typeof define && define.amd ? define(["jquery"], function(t) {
        i(t, window, document)
    ...
    p.intlTelInputGlobals = {
        getInstance: function(t) {
            ...
            return p.intlTelInputGlobals.instances[i]
        },
        instances: {}
    };
    var r = 0,
    ...
    p.addEventListener("load", function() {
        p.intlTelInputGlobals.windowLoaded = !0
    });
    ...
    function d(i) {
        u(p.intlTelInputGlobals.instances, function(t) {
            p.intlTelInputGlobals.instances[t][i]()
        })
    }
    var h, c, f = (t((h = _).prototype, [{
        key: "_init",
        value: function() {
            var e = this;
        ...
        value: function(t, i, e) {
            ...
            for (var a = 0; a < this.q[i].length; a++)
                if (this.q[i][a] === t) return;
            var n = e !== s ? e : this.q[i].length;
            this.q[i][n] = t
        }
    }, {
        key: "_d",
        ...
        value: function() {
            ...
            if (this.a.parentNode.insertBefore(i, this.a), this.k = this._e2("div", {
                ...
                if (a) {
                    var n = a.lastIndexOf("["); - 1 !== n && (e = "".concat(a.substr(0, n), "[").concat(e, "]"))
                }
        ...
        value: function() {
            ...
            i && !e ? this._v(t) : "auto" !== n && (n ? this._z(n.toLowerCase()) : i && e ? this._z("us") : (this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2, t || this._z(this.j)), t || s || o || r || (this.a.value = "+".concat(this.s.dialCode))), t && this._u(t)
        }
    }, {
        key: "_i",
        value: function() {
        ...
        value: function() {
            ...
            t && t.addEventListener("click", this._a9), this._a10 = function() {
                ...
                i.m.classList.contains("iti__hide") && -1 !== ["ArrowUp", "ArrowDown", " ", "Enter"].indexOf(t.key) && (t.preventDefault(), t.stopPropagation(), i._n()), "Tab" === t.key && i._2()
        ...
        value: function() {
            var t = this;
            this.d.utilsScript && !p.intlTelInputUtils ? p.intlTelInputGlobals.windowLoaded ? p.intlTelInputGlobals.loadUtils(this.d.utilsScript) : p.addEventListener("load", function() {
                p.intlTelInputGlobals.loadUtils(t.d.utilsScript)
            }) : this.i0(), "auto" === this.d.initialCountry ? this._i4() : this.h()
        }
    }, {
        key: "_i4",
        value: function() {
            p.intlTelInputGlobals.autoCountry ? this.handleAutoCountry() : p.intlTelInputGlobals.startedLoadingAutoCountry || (p.intlTelInputGlobals.startedLoadingAutoCountry = !0, "function" == typeof this.d.geoIpLookup && this.d.geoIpLookup(function(t) {
                p.intlTelInputGlobals.autoCountry = t.toLowerCase(), setTimeout(function() {
        ...
        value: function() {
            ...
            if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.g) {
                var i = this.a.getBoundingClientRect(),
                    e = p.pageYOffset || v.documentElement.scrollTop,
                    a = i.top + e,
                    n = this.m.offsetHeight,
                    s = a + this.a.offsetHeight + n < e + p.innerHeight,
                    o = e < a - n;
                if (this._n2(this.m, "iti__country-list--dropup", !s && o), this.d.dropdownContainer) {
                    var r = !s && o ? 0 : this.a.offsetHeight;
                    this.dropdown.style.top = "".concat(a + r, "px"), this.dropdown.style.left = "".concat(i.left + v.body.scrollLeft, "px"), this._a4 = function() {
                        return t._2()
                    }, p.addEventListener("scroll", this._a4)
                }
            }
        }
    }, {
        ...
        value: function() {
            ...
            this._a2 = function() {
                t || e._2(), t = !1
            }, v.documentElement.addEventListener("click", this._a2);
            var i = "",
                a = null;
            this._a3 = function(t) {
                t.preventDefault(), "ArrowUp" === t.key || "ArrowDown" === t.key ? e._q(t.key) : "Enter" === t.key ? e._r() : "Escape" === t.key ? e._2() : /^[a-zA-ZÀ-ÿ ]$/.test(t.key) && (a && clearTimeout(a), i += t.key.toLowerCase(), e._s(i), a = setTimeout(function() {
                    i = ""
                }, 1e3))
            }, v.addEventListener("keydown", this._a3)
        }
    }, {
        key: "_q",
        value: function(t) {
            var i = "ArrowUp" === t ? this.c.previousElementSibling : this.c.nextElementSibling;
            i && (i.classList.contains("iti__divider") && (i = "ArrowUp" === t ? i.previousElementSibling : i.nextElementSibling), this._x(i, !0))
        }
    }, {
        key: "_r",
        value: function() {
        ...
        value: function(t) {
            var i = t;
            if (this.d.formatOnDisplay && p.intlTelInputUtils && this.s) {
        ...
        value: function(t) {
            var i = t,
                e = this.s.dialCode,
                a = "1" === e;
            i && this.d.nationalMode && a && "+" !== i.charAt(0) && ("1" !== i.charAt(0) && (i = "1".concat(i)), i = "+".concat(i)), this.d.separateDialCode && e && "+" !== i.charAt(0) && (i = "+".concat(e).concat(i));
            var n = this._5(i),
                s = this._m(i),
                o = null;
            if (n) {
                var r = this.q[this._m(n)],
                    l = -1 !== r.indexOf(this.s.iso2) && s.length <= n.length - 1;
                if (!("1" === e && this._w(s) || l))
        ...
        key: "_y",
        value: function(t, i, e) {
            for (var a = i ? o : this.p, n = 0; n < a.length; n++)
                if (a[n].iso2 === t) return a[n];
            if (e) return null;
        ...
        value: function(t) {
            ...
            if (this._0(), this.d.allowDropdown) {
                ...
                if (s && (s.classList.remove("iti__active"), s.setAttribute("aria-selected", "false")), t) {
                    var o = this.m.querySelector("#iti-item-".concat(t));
                    o.setAttribute("aria-selected", "true"), o.classList.add("iti__active"), this.b = o, this.m.setAttribute("aria-activedescendant", o.getAttribute("id"))
                }
            }
            return i.iso2 !== t
        }
        ...
        value: function() {
            ...
            t.style.visibility = "hidden", v.body.appendChild(t);
        ...
        value: function(t) {
            ...
            this.a.setSelectionRange(e, e), i && this._8()
        }
    }, {
        key: "_2",
        value: function() {
            this.m.classList.add("iti__hide"), this.m.setAttribute("aria-expanded", "false"), this.u.classList.remove("iti__arrow--up"), v.removeEventListener("keydown", this._a3), v.documentElement.removeEventListener("click", this._a2), this.m.removeEventListener("mouseover", this._a0), this.m.removeEventListener("click", this._a1), this.d.dropdownContainer && (this.g || p.removeEventListener("scroll", this._a4), this.dropdown.parentNode && this.dropdown.parentNode.removeChild(this.dropdown)), this._m2("close:countrydropdown")
        }
    }, {
        key: "_3",
        value: function(t, i) {
            var e = this.m,
                a = p.pageYOffset || v.documentElement.scrollTop,
                n = e.offsetHeight,
        ...
        value: function() {
            "auto" === this.d.initialCountry && (this.j = p.intlTelInputGlobals.autoCountry, this.a.value || this.setCountry(this.j), this.h())
        }
    }, {
        key: "handleUtils",
        value: function() {
            p.intlTelInputUtils && (this.a.value && this._u(this.a.value), this._0()), this.i0()
        }
    }, {
        key: "destroy",
        value: function() {
            ...
            e.parentNode.insertBefore(this.a, e), e.parentNode.removeChild(e), delete p.intlTelInputGlobals.instances[this.id]
        }
    }, {
        key: "getExtension",
        value: function() {
            return p.intlTelInputUtils ? intlTelInputUtils.getExtension(this._6(), this.s.iso2) : ""
        }
    }, {
        key: "getNumber",
        value: function(t) {
        ...
        key: "getNumberType",
        value: function() {
            return p.intlTelInputUtils ? intlTelInputUtils.getNumberType(this._6(), this.s.iso2) : -99
        }
    }, {
        ...
        value: function() {
            ...
            return p.intlTelInputUtils ? intlTelInputUtils.isValidNumber(t, i) : null
        }
    }, {
        key: "setCountry",
        value: function(t) {
            var i = t.toLowerCase();
            this.l.classList.contains("iti__".concat(i)) || (this._z(i), this._4(this.s.dialCode, !1), this._8())
        }
    }, {
        key: "setNumber",
        value: function(t) {
    ...
    function _(t, i) {
        ...
        })(this, _), this.id = r++, this.a = t, this.b = null, this.c = null;
        var a = i || {};
    ...
    function m(t, i, e) {
        ...
        }, a.className = "iti-load-utils", a.async = !0, a.src = t, v.body.appendChild(a)
    }
    p.intlTelInputGlobals.loadUtils = function(e) {
        if (!p.intlTelInputUtils && !p.intlTelInputGlobals.startedLoadingUtilsScript) {
            if (p.intlTelInputGlobals.startedLoadingUtilsScript = !0, "undefined" != typeof Promise) return new Promise(function(t, i) {
                return m(e, t, i)
            });
            m(e)
        }
        return null
    }, p.intlTelInputGlobals.defaults = l, p.intlTelInputGlobals.version = "16.0.2", n.fn.intlTelInput = function(i) {
        var e, a = arguments;
        return i === s || "object" == typeof i ? this.each(function() {
            if (!n.data(this, "plugin_intlTelInput")) {
                var t = new f(this, i);
                t._init(), p.intlTelInputGlobals.instances[t.id] = t, n.data(this, "plugin_intlTelInput", t)
            }
        }) : "string" == typeof i && "_" !== i[0] ? (this.each(function() {
            var t = n.data(this, "plugin_intlTelInput");
            t instanceof f && "function" == typeof t[i] && (e = t[i].apply(t, Array.prototype.slice.call(a, 1))), "destroy" === i && n.data(this, "plugin_intlTelInput", null)
        }), e !== s ? e : this) : void 0
    }
});