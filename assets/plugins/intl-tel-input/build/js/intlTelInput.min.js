! function() {
    var t = function(p, f) {
        ...
        return function() {
            ...
            function l(i) {
                r(p.intlTelInputGlobals.instances, function(t) {
                    p.intlTelInputGlobals.instances[t][i]()
                })
            }
            var u, d, h = (t((u = c).prototype, [{
                key: "_init",
                value: function() {
                    var e = this;
                ...
                value: function(t, i, e) {
                    ...
                    var n = void 0 !== e ? e : this.q[i].length;
                    this.q[i][n] = t
                }
            }, {
                key: "_d",
                ...
                value: function() {
                    ...
                    if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.g) {
                        var i = this.a.getBoundingClientRect(),
                            e = p.pageYOffset || f.documentElement.scrollTop,
                            a = i.top + e,
                        ...
                        if (this._n2(this.m, "iti__country-list--dropup", !s && o), this.d.dropdownContainer) {
                            ...
                            this.dropdown.style.top = "".concat(a + r, "px"), this.dropdown.style.left = "".concat(i.left + f.body.scrollLeft, "px"), this._a4 = function() {
                                return t._2()
                ...
                value: function() {
                    ...
                    t.style.visibility = "hidden", f.body.appendChild(t);
                ...
                value: function(t, i) {
                    var e = this.m,
                        a = p.pageYOffset || f.documentElement.scrollTop,
                        n = e.offsetHeight,
            ...
            function c(t, i) {
                ...
                })(this, c), this.id = n++, this.a = t, this.b = null, this.c = null;
                var a = i || {};
                this.d = {}, r(o, function(t, i) {
            ...
            function v(t, i, e) {
                ...
                a.onload = function() {
                    ...
                    l("rejectUtilsScriptPromise"), e && e()
                }, a.className = "iti-load-utils", a.async = !0, a.src = t, f.body.appendChild(a)
            }
            return p.intlTelInputGlobals.loadUtils = function(e) {
                    ...
                    return null
                }, p.intlTelInputGlobals.defaults = o, p.intlTelInputGlobals.version = "16.0.2",
                function(t, i) {
                    var e = new h(t, i);
                    return e._init(), t.setAttribute("data-intl-tel-input-id", e.id), p.intlTelInputGlobals.instances[e.id] = e
                }
        }()
    }(window, document);
